...
.form-grid {
    display: grid;
    grid-template-columns: 1fr 320px; /* main form + sidebar */
    gap: 1.5rem;
}
...
.form-row {
    display: grid;
    grid-template-columns: 1fr 1fr 1fr; /* three-column row: volunteers, image, badge */
    gap: 0.75rem;
}
...
<div class="edit-event-wrap">
    <div class="card-header">
        ...
        <h1 style="margin: 0; font-size: 1.25rem; color: #2c5f2d;">Edit Event</h1>
    </div>
                ...
                <aside class="sidebar">
                    ...
                    <div class="meta-box">
                        <div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;">
                            <strong style="color:#2c5f2d">Created</strong>
                            <span>{{ $event->created_at->format('M d, Y') }}</span>
                        </div>
                        <div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;">
                            <strong style="color:#2c5f2d">Last Updated</strong>
                            <span>{{ $event->updated_at->diffForHumans() }}</span>
                        </div>
                        <div style="display:flex; justify-content:space-between;">
                            <strong style="color:#2c5f2d">ID</strong>
                            <span>#{{ $event->id }}</span>
                        </div>
                    </div>
                </aside>
